...
local a = require('wsain.treesitter.async')
local log = require('wsain.treesitter.log')
...
local function try_install_lang(lang, cache_dir, install_dir, generate)
  ...
  do -- install queries
    local query_src = M.get_package_path("wsain", "treesitter", "queries", lang)
...
local function reload_parsers()
  package.loaded['wsain.treesitter.parsers'] = nil
  ---@diagnostic disable-next-line:duplicate-require
  parsers = require('wsain.treesitter.parsers')
